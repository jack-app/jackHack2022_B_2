...
export default class BootScene extends Scene {
    ...
    preload() {
        ...
        var orangeKeyImages = require()
        this.load.image('orangeKeyImages', [orangeKeyImages]);
        for (var i = 0; i < keyList.length; i++) {
            var KeyImage = require('@/game/assets/keyboard/key_orange/key_' + keyList[i] + '.png')
            this.orangeKeyImages[keyList[i]] = this.load.image(String('key_' + keyList[i]), [KeyImage])
